...
plot_before_vs_after(root_path=root_path, data_path=paste(root_path,"/processed_data/individual_behaviour/pre_vs_post_treatment",sep=""),analysis=analysis,status="all",collective=F,pool_plot=F,pattern="individual_behavioural_data",plot_untransformed = T,boldy=T,Adriano_subset="big");title(main="big")
plot_before_vs_after(root_path=root_path, data_path=paste(root_path,"/processed_data/individual_behaviour/pre_vs_post_treatment",sep=""),analysis=analysis,status="all",collective=F,pool_plot=F,pattern="individual_behavioural_data",plot_untransformed = T,boldy=T,Adriano_subset="small");title(main="small")

plot_before_vs_after(root_path=root_path, data_path=paste(root_path,"/processed_data/individual_behaviour/pre_vs_post_treatment",sep=""),analysis=analysis,status="all",collective=F,pool_plot=F,pattern="individual_behavioural_data",plot_untransformed = T,boldy=T,Adriano_subset="pathogen");title(main="pathogen")
plot_before_vs_after(root_path=root_path, data_path=paste(root_path,"/processed_data/individual_behaviour/pre_vs_post_treatment",sep=""),analysis=analysis,status="all",collective=F,pool_plot=F,pattern="individual_behavioural_data",plot_untransformed = T,boldy=T,Adriano_subset="control");title(main="control")
...
transf_variable_list <- c("none","none","none","none","none","none","none","none")   ######"none", "sqrt" "log","power2"
analysis <- list(variable_list=variable_list,
                 transf_variable_list=transf_variable_list,
...
plot_before_vs_after(root_path=root_path, data_path=paste(root_path,"/network_properties/pre_vs_post_treatment/all_workers",sep=""),analysis=analysis,status="collective",collective=T,pool_plot=T,pattern="colony_data.txt",Adriano_subset="big")
plot_before_vs_after(root_path=root_path, data_path=paste(root_path,"/network_properties/pre_vs_post_treatment/all_workers",sep=""),analysis=analysis,status="collective",collective=T,pool_plot=T,pattern="colony_data.txt",Adriano_subset="small")
...
analysis <- list(variable_list=variable_list,
                 ...
                 predictor_list=predictor_list,
                 violin_plot_param = list(c(1.5,0,-0.02,1,0.1)))
plot_before_vs_after(root_path=root_path, data_path=paste(root_path,"/processed_data/individual_behaviour/pre_vs_post_treatment",sep=""),analysis=analysis,status="all",collective=F,pool_plot=F,pattern="individual_behavioural_data",plot_untransformed = T,boldy=T,Adriano_subset="big")
plot_before_vs_after(root_path=root_path, data_path=paste(root_path,"/processed_data/individual_behaviour/pre_vs_post_treatment",sep=""),analysis=analysis,status="all",collective=F,pool_plot=F,pattern="individual_behavioural_data",plot_untransformed = T,boldy=T,Adriano_subset="small")
